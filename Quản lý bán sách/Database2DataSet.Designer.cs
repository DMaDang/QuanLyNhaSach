...
namespace Quản_lý_bán_sách {
    ...
    public partial class Database2DataSet : global::System.Data.DataSet {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NhanVienRow AddNhanVienRow(string maNhanVien, string userName, string tenNhanVien, string congViec, string diaChi, string gioiTinh, System.DateTime ngaySinh, string email, double luong) {
...
namespace Quản_lý_bán_sách.Database2DataSetTableAdapters {
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[NhanVien] WHERE (([maNhanVien] = @Original_maNhanVien) AND ((@IsNull_userName = 1 AND [userName] IS NULL) OR ([userName] = @Original_userName)) AND ((@IsNull_tenNhanVien = 1 AND [tenNhanVien] IS NULL) OR ([tenNhanVien] = @Original_tenNhanVien)) AND ((@IsNull_congViec = 1 AND [congViec] IS NULL) OR ([congViec] = @Original_congViec)) AND ((@IsNull_diaChi = 1 AND [diaChi] IS NULL) OR ([diaChi] = @Original_diaChi)) AND ((@IsNull_gioiTinh = 1 AND [gioiTinh] IS NULL) OR ([gioiTinh] = @Original_gioiTinh)) AND ((@IsNull_ngaySinh = 1 AND [ngaySinh] IS NULL) OR ([ngaySinh] = @Original_ngaySinh)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_luong = 1 AND [luong] IS NULL) OR ([luong] = @Original_luong)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NhanVien] ([maNhanVien], [userName], [tenNhanVien], [congViec], [diaChi], [gioiTinh], [ngaySinh], [email], [luong]) VALUES (@maNhanVien, @userName, @tenNhanVien, @congViec, @diaChi, @gioiTinh, @ngaySinh, @email, @luong);
SELECT maNhanVien, userName, tenNhanVien, congViec, diaChi, gioiTinh, ngaySinh, email, luong FROM NhanVien WHERE (maNhanVien = @maNhanVien)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [maNhanVien] = @maNhanVien, [userName] = @userName, [tenNhanVien] = @tenNhanVien, [congViec] = @congViec, [diaChi] = @diaChi, [gioiTinh] = @gioiTinh, [ngaySinh] = @ngaySinh, [email] = @email, [luong] = @luong WHERE (([maNhanVien] = @Original_maNhanVien) AND ((@IsNull_userName = 1 AND [userName] IS NULL) OR ([userName] = @Original_userName)) AND ((@IsNull_tenNhanVien = 1 AND [tenNhanVien] IS NULL) OR ([tenNhanVien] = @Original_tenNhanVien)) AND ((@IsNull_congViec = 1 AND [congViec] IS NULL) OR ([congViec] = @Original_congViec)) AND ((@IsNull_diaChi = 1 AND [diaChi] IS NULL) OR ([diaChi] = @Original_diaChi)) AND ((@IsNull_gioiTinh = 1 AND [gioiTinh] IS NULL) OR ([gioiTinh] = @Original_gioiTinh)) AND ((@IsNull_ngaySinh = 1 AND [ngaySinh] IS NULL) OR ([ngaySinh] = @Original_ngaySinh)) AND ((@IsNull_email = 1 AND [email] IS NULL) OR ([email] = @Original_email)) AND ((@IsNull_luong = 1 AND [luong] IS NULL) OR ([luong] = @Original_luong)));
SELECT maNhanVien, userName, tenNhanVien, congViec, diaChi, gioiTinh, ngaySinh, email, luong FROM NhanVien WHERE (maNhanVien = @maNhanVien)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Quản_lý_bán_sách.Properties.Settings.Default.Database2ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT maNhanVien, userName, tenNhanVien, congViec, diaChi, gioiTinh, ngaySinh, e" +
                "mail, luong FROM dbo.NhanVien";
        ...
        public virtual int Fill(Database2DataSet.NhanVienDataTable dataTable) {
        ...
        public virtual Database2DataSet.NhanVienDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database2DataSet.NhanVienDataTable dataTable = new Database2DataSet.NhanVienDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database2DataSet.NhanVienDataTable dataTable) {
        ...
        public virtual int Delete(string Original_maNhanVien, string Original_userName, string Original_tenNhanVien, string Original_congViec, string Original_diaChi, string Original_gioiTinh, global::System.Nullable<global::System.DateTime> Original_ngaySinh, string Original_email, global::System.Nullable<double> Original_luong) {
            ...
            if ((Original_congViec == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_congViec));
            }
        ...
        public virtual int Insert(string maNhanVien, string userName, string tenNhanVien, string congViec, string diaChi, string gioiTinh, global::System.Nullable<global::System.DateTime> ngaySinh, string email, global::System.Nullable<double> luong) {
            if ((maNhanVien == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_congViec == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(Original_congViec));
            }
            if ((Original_diaChi == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_email, 
                    global::System.Nullable<double> Original_luong) {
            return this.Update(Original_maNhanVien, userName, tenNhanVien, congViec, diaChi, gioiTinh, ngaySinh, email, luong, Original_maNhanVien, Original_userName, Original_tenNhanVien, Original_congViec, Original_diaChi, Original_gioiTinh, Original_ngaySinh, Original_email, Original_luong);
        }
    }
